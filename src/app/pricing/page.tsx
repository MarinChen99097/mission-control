...
const PLANS = [
  {
    name: 'Starter',
    price: 20,
    description: 'Try your own AI agent. Perfect for getting started.',
    features: [
      'Your own AI agent, always on',
      'Connect Google Drive',
      '$5 AI credits included each month',
      'Add up to 3 skills',
  ...
  },
  {
    name: 'Pro',
    price: 60,
    description: 'More power, more integrations. Our most popular plan.',
    features: [
      'Everything in Starter, plus:',
      '2x faster processing',
      'Connect Notion + Google Drive',
      '$15 AI credits included each month',
      'Add up to 10 skills',
  ...
  },
  {
    name: 'Max',
    price: 180,
    description: 'Maximum power for teams and heavy workloads.',
    features: [
      ...
      'Dedicated support',
      'Priority setup (under 30 seconds)',
    ],
    cta: 'Go Max',
    highlighted: false,
  },
