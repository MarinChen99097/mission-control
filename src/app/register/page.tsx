  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-sm">
        ...
        {/* Google OAuth — fastest way to sign up */}
        <button
          type="button"
          onClick={() => {
            // Redirect to Marketing Backend Google OAuth
            window.location.href = `${MARKETING_BACKEND_URL}/auth/google?redirect=${encodeURIComponent(window.location.origin + '/login?registered=1')}`
          }}
          className="w-full h-11 flex items-center justify-center gap-3 rounded-lg border border-border bg-white text-[#3c4043] text-sm font-medium hover:bg-gray-50 transition-colors mb-4"
        >
