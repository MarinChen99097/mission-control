...
export function proxy(request: NextRequest) {
  ...
  if (isPublicPage || pathname.startsWith('/api/auth/') || pathname === '/api/setup' || pathname === '/api/docs' || pathname === '/api/stripe/checkout' || pathname.startsWith('/api/webhooks/stripe') || isPublicHealthProbe) {
