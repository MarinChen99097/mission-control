...
export const createTaskSchema = z.object({
  ...
  status: z.enum(['inbox', 'assigned', 'in_progress', 'review', 'quality_review', 'awaiting_owner', 'rework_requested', 'done']).default('inbox'),
...
export const bulkUpdateTaskStatusSchema = z.object({
  tasks: z.array(z.object({
    ...
    status: z.enum(['inbox', 'assigned', 'in_progress', 'review', 'quality_review', 'awaiting_owner', 'rework_requested', 'done']),
